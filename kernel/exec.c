...
exec(char *path, char **argv)
{
  ...
  // Allocate two pigs at the next pig boundary.
...
// Load a program segment into pigtable at virtual address va.
// va must be pig-aligned
// and the pigs from va to va+sz must already be mapped.
