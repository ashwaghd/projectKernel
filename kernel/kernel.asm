...
w_mscratch(uint64 x)
{
  ...
  asm volatile("csrw mtvec, %0" : : "r" (x));
    ...
    80000066:	ade78793          	add	a5,a5,-1314 # 80005b40 <timervec>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80001010:	3a5d                	addw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdd297>
    ...
    80001780:	c2dd                	beqz	a3,80001826 <copyinstr+0xa6>
{
  ...
  while(got_null == 0 && max > 0){
    ...
    80001804:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffdd2a0>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001864:	120a0a13          	add	s4,s4,288 # 80016980 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001930:	05498993          	add	s3,s3,84 # 80016980 <tickslock>
      initlock(&p->lock, "proc");
...
0000000080001a24 <allocpid>:
{
  ...
  pid = nextpid;
    ...
    80001a46:	e0278793          	add	a5,a5,-510 # 80008844 <nextpid>
...
0000000080001bb0 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001bc8:	dbc90913          	add	s2,s2,-580 # 80016980 <tickslock>
    acquire(&p->lock);
...
0000000080001c7e <userinit>:
{
  ...
  initproc = p;
    ...
    80001c96:	c4a7b323          	sd	a0,-954(a5) # 800088d8 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    80001c9a:	03400613          	li	a2,52
    80001c9e:	00007597          	auipc	a1,0x7
    80001ca2:	bb258593          	add	a1,a1,-1102 # 80008850 <initcode>
...
0000000080001d5c <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001e4e:	d1e48493          	add	s1,s1,-738 # 80010b68 <wait_lock>
...
0000000080001e9c <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001ebc:	c9870713          	add	a4,a4,-872 # 80010b50 <pid_lock>
    80001ec0:	9756                	add	a4,a4,s5
    80001ec2:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001ec6:	0000f717          	auipc	a4,0xf
    80001eca:	cc270713          	add	a4,a4,-830 # 80010b88 <cpus+0x8>
    ...
    80001eda:	c7aa0a13          	add	s4,s4,-902 # 80010b50 <pid_lock>
    80001ede:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001ee0:	00015917          	auipc	s2,0x15
    80001ee4:	aa090913          	add	s2,s2,-1376 # 80016980 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001ef8:	08c48493          	add	s1,s1,140 # 80010f80 <proc>
...
0000000080001f3c <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001f68:	bec70713          	add	a4,a4,-1044 # 80010b50 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001f8e:	bc690913          	add	s2,s2,-1082 # 80010b50 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001fa6:	be658593          	add	a1,a1,-1050 # 80010b88 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020ca:	eba48493          	add	s1,s1,-326 # 80010f80 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020d6:	8ae90913          	add	s2,s2,-1874 # 80016980 <tickslock>
...
0000000080002128 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000213e:	e4648493          	add	s1,s1,-442 # 80010f80 <proc>
      pp->parent = initproc;
    80002142:	00006a17          	auipc	s4,0x6
    80002146:	796a0a13          	add	s4,s4,1942 # 800088d8 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    8000214a:	00015997          	auipc	s3,0x15
    8000214e:	83698993          	add	s3,s3,-1994 # 80016980 <tickslock>
...
0000000080002182 <exit>:
{
  ...
  if(p == initproc)
    ...
    800021a2:	73a7b783          	ld	a5,1850(a5) # 800088d8 <initproc>
  ...
  acquire(&wait_lock);
    ...
    800021fe:	96e48493          	add	s1,s1,-1682 # 80010b68 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000226c:	d1848493          	add	s1,s1,-744 # 80010f80 <proc>
    80002270:	00014997          	auipc	s3,0x14
    80002274:	71098993          	add	s3,s3,1808 # 80016980 <tickslock>
    acquire(&p->lock);
...
0000000080002328 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002350:	81c50513          	add	a0,a0,-2020 # 80010b68 <wait_lock>
    ...
    80002366:	61e98993          	add	s3,s3,1566 # 80016980 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000236a:	0000ec17          	auipc	s8,0xe
    8000236e:	7fec0c13          	add	s8,s8,2046 # 80010b68 <wait_lock>
    ...
    800023ac:	7c050513          	add	a0,a0,1984 # 80010b68 <wait_lock>
    ...
    800023e0:	78c50513          	add	a0,a0,1932 # 80010b68 <wait_lock>
    ...
    8000243c:	b4848493          	add	s1,s1,-1208 # 80010f80 <proc>
    80002440:	bf65                	j	800023f8 <wait+0xd0>
      release(&wait_lock);
    80002442:	0000e517          	auipc	a0,0xe
    80002446:	72650513          	add	a0,a0,1830 # 80010b68 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000252c:	bb048493          	add	s1,s1,-1104 # 800110d8 <proc+0x158>
    80002530:	00014917          	auipc	s2,0x14
    80002534:	5a890913          	add	s2,s2,1448 # 80016ad8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002630:	35450513          	add	a0,a0,852 # 80016980 <tickslock>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000264e:	46678793          	add	a5,a5,1126 # 80005ab0 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80002700:	28448493          	add	s1,s1,644 # 80016980 <tickslock>
  ...
  ticks++;
    ...
    80002712:	1d250513          	add	a0,a0,466 # 800088e0 <ticks>
...
00000000800027de <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800027f8:	2bc78793          	add	a5,a5,700 # 80005ab0 <kernelvec>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002c8e:	cf650513          	add	a0,a0,-778 # 80016980 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80002cac:	cd898993          	add	s3,s3,-808 # 80016980 <tickslock>
    80002cb0:	00006497          	auipc	s1,0x6
    80002cb4:	c3048493          	add	s1,s1,-976 # 800088e0 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002ce8:	c9c50513          	add	a0,a0,-868 # 80016980 <tickslock>
  ...
  return 0;
    ...
    80002d08:	c7c50513          	add	a0,a0,-900 # 80016980 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002d50:	c3450513          	add	a0,a0,-972 # 80016980 <tickslock>
  ...
  release(&tickslock);
    ...
    80002d68:	c1c50513          	add	a0,a0,-996 # 80016980 <tickslock>
...
binit(void)
{
    ...
    80002d92:	1800                	add	s0,sp,48
  struct buf *b;

  initlock(&bcache.lock, "bcache");
    80002d94:	00005597          	auipc	a1,0x5
    80002d98:	76c58593          	add	a1,a1,1900 # 80008500 <syscalls+0xb0>
    80002d9c:	00014517          	auipc	a0,0x14
    80002da0:	bfc50513          	add	a0,a0,-1028 # 80016998 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002db0:	bec78793          	add	a5,a5,-1044 # 8001e998 <bcache+0x8000>
    80002db4:	0001c717          	auipc	a4,0x1c
    80002db8:	e4c70713          	add	a4,a4,-436 # 8001ec00 <bcache+0x8268>
    80002dbc:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dc0:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dc4:	00014497          	auipc	s1,0x14
    80002dc8:	bec48493          	add	s1,s1,-1044 # 800169b0 <bcache+0x18>
    ...
    80002dd4:	738a0a13          	add	s4,s4,1848 # 80008508 <syscalls+0xb8>
    b->next = bcache.head.next;
    ...
    80002de4:	01048513          	add	a0,s1,16
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dfa:	45848493          	add	s1,s1,1112
...
bread(uint dev, uint blockno)
{
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002e40:	dc478793          	add	a5,a5,-572 # 8001ec00 <bcache+0x8268>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e8e:	d7678793          	add	a5,a5,-650 # 8001ec00 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002ea6:	66e50513          	add	a0,a0,1646 # 80008510 <syscalls+0xc0>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002f36:	5f650513          	add	a0,a0,1526 # 80008528 <syscalls+0xd8>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80002f50:	01050913          	add	s2,a0,16
  ...
  if (b->refcnt == 0) {
    ...
    80002f94:	a0878793          	add	a5,a5,-1528 # 8001e998 <bcache+0x8000>
    80002f98:	2b87b703          	ld	a4,696(a5)
    80002f9c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002f9e:	0001c717          	auipc	a4,0x1c
    80002fa2:	c6270713          	add	a4,a4,-926 # 8001ec00 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fb6:	9e650513          	add	a0,a0,-1562 # 80016998 <bcache>
    ...
    80002fca:	6105                	add	sp,sp,32
    80002fcc:	8082                	ret
    panic("brelse");
    80002fce:	00005517          	auipc	a0,0x5
    80002fd2:	56250513          	add	a0,a0,1378 # 80008530 <syscalls+0xe0>
...
bunpin(struct buf *b) {
    ...
    80003022:	1000                	add	s0,sp,32
    80003024:	84aa                	mv	s1,a0
  acquire(&bcache.lock);
    80003026:	00014517          	auipc	a0,0x14
    8000302a:	97250513          	add	a0,a0,-1678 # 80016998 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003040:	95c50513          	add	a0,a0,-1700 # 80016998 <bcache>
...
00000000800030d2 <balloc>:
{
  ...
  memset(bp->data, 0, BSIZE);
    ...
    8000313c:	05850513          	add	a0,a0,88
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    bp = bread(dev, BBLOCK(b, sb));
    80003192:	41fad79b          	sraw	a5,s5,0x1f
    80003196:	0137d79b          	srlw	a5,a5,0x13
    8000319a:	015787bb          	addw	a5,a5,s5
    8000319e:	40d7d79b          	sraw	a5,a5,0xd
    ...
    800031be:	faa4fde3          	bgeu	s1,a0,80003178 <balloc+0xa6>
      m = 1 << (bi % 8);
    800031c2:	00777693          	and	a3,a4,7
    800031c6:	00d996bb          	sllw	a3,s3,a3
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    800031ca:	41f7579b          	sraw	a5,a4,0x1f
    800031ce:	01d7d79b          	srlw	a5,a5,0x1d
    800031d2:	9fb9                	addw	a5,a5,a4
    800031d4:	4037d79b          	sraw	a5,a5,0x3
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    8000321c:	02059793          	sll	a5,a1,0x20
    80003220:	01e7d593          	srl	a1,a5,0x1e
  ...
  bn -= NDIRECT;
    80003248:	ff45849b          	addw	s1,a1,-12
  ...
  if(bn < NINDIRECT){
    ...
    a = (uint*)bp->data;
    80003286:	05850793          	add	a5,a0,88
    if((addr = a[bn]) == 0){
    8000328a:	02049713          	sll	a4,s1,0x20
    8000328e:	01e75593          	srl	a1,a4,0x1e
...
00000000800032ee <iget>:
{
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003318:	d7c48493          	add	s1,s1,-644 # 8001f090 <itable+0x18>
    8000331c:	0001e697          	auipc	a3,0x1e
    80003320:	80468693          	add	a3,a3,-2044 # 80020b20 <log>
    80003324:	a039                	j	80003332 <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80003326:	02090b63          	beqz	s2,8000335c <iget+0x6e>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    8000332a:	08848493          	add	s1,s1,136
    ...
    80003340:	ff4713e3          	bne	a4,s4,80003326 <iget+0x38>
      ip->ref++;
    80003344:	2785                	addw	a5,a5,1
    80003346:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80003348:	0001c517          	auipc	a0,0x1c
    8000334c:	d3050513          	add	a0,a0,-720 # 8001f078 <itable>
  ...
  release(&itable.lock);
    ...
    8000337c:	d0050513          	add	a0,a0,-768 # 8001f078 <itable>
    ...
    8000339e:	1e650513          	add	a0,a0,486 # 80008580 <syscalls+0x130>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033ca:	c9298993          	add	s3,s3,-878 # 8001f058 <sb>
    800033ce:	02000613          	li	a2,32
    800033d2:	05850593          	add	a1,a0,88
  ...
  if(sb.magic != FSMAGIC)
    ...
    800033f2:	04078793          	add	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    800033f6:	02f71263          	bne	a4,a5,8000341a <fsinit+0x70>
  initlog(dev, &sb);
    800033fa:	0001c597          	auipc	a1,0x1c
    800033fe:	c5e58593          	add	a1,a1,-930 # 8001f058 <sb>
...
000000008000342a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000343c:	17058593          	add	a1,a1,368 # 800085a8 <syscalls+0x158>
    80003440:	0001c517          	auipc	a0,0x1c
    80003444:	c3850513          	add	a0,a0,-968 # 8001f078 <itable>
    80003448:	ffffd097          	auipc	ra,0xffffd
    8000344c:	6fa080e7          	jalr	1786(ra) # 80000b42 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003450:	0001c497          	auipc	s1,0x1c
    80003454:	c5048493          	add	s1,s1,-944 # 8001f0a0 <itable+0x28>
    80003458:	0001d997          	auipc	s3,0x1d
    8000345c:	6d898993          	add	s3,s3,1752 # 80020b30 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003460:	00005917          	auipc	s2,0x5
    80003464:	15090913          	add	s2,s2,336 # 800085b0 <syscalls+0x160>
  ...
  for(i = 0; i < NINODE; i++) {
    80003474:	08848493          	add	s1,s1,136
...
000000008000348a <ialloc>:
{
    ...
    8000349c:	0080                	add	s0,sp,64
  for(inum = 1; inum < sb.ninodes; inum++){
    8000349e:	0001c717          	auipc	a4,0x1c
    800034a2:	bc672703          	lw	a4,-1082(a4) # 8001f064 <sb+0xc>
    ...
    800034b6:	ba6a0a13          	add	s4,s4,-1114 # 8001f058 <sb>
    800034ba:	00495593          	srl	a1,s2,0x4
    ...
    800034d0:	05850993          	add	s3,a0,88
    800034d4:	00f97793          	and	a5,s2,15
    800034d8:	079a                	sll	a5,a5,0x6
  ...
  printf("ialloc: no inodes\n");
    ...
    800034fc:	0c050513          	add	a0,a0,192 # 800085b8 <syscalls+0x168>
...
0000000080003556 <iupdate>:
{
  ...
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003580:	05850793          	add	a5,a0,88
    80003584:	40d8                	lw	a4,4(s1)
    80003586:	8b3d                	and	a4,a4,15
    80003588:	071a                	sll	a4,a4,0x6
  ...
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    ...
    800035b4:	05048593          	add	a1,s1,80
    800035b8:	00c78513          	add	a0,a5,12
...
0000000080003622 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003684:	8bbd                	and	a5,a5,15
    80003686:	079a                	sll	a5,a5,0x6
    ...
    800036b2:	05b1                	add	a1,a1,12
    800036b4:	05048513          	add	a0,s1,80
    ...
    800036d8:	f0450513          	add	a0,a0,-252 # 800085d8 <syscalls+0x188>
...
00000000800036e4 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    ...
    800036f4:	01050913          	add	s2,a0,16
  ...
  releasesleep(&ip->lock);
    ...
    80003724:	ec850513          	add	a0,a0,-312 # 800085e8 <syscalls+0x198>
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    80003742:	05050493          	add	s1,a0,80
    80003746:	08050913          	add	s2,a0,128
    8000374a:	a021                	j	80003752 <itrunc+0x22>
    8000374c:	0491                	add	s1,s1,4
  ...
  iupdate(ip);
    ...
    8000379a:	05850493          	add	s1,a0,88
    8000379e:	45850913          	add	s2,a0,1112
    800037a2:	a021                	j	800037aa <itrunc+0x7a>
    800037a4:	0491                	add	s1,s1,4
...
00000000800037dc <iput>:
{
    ...
    800037e6:	1000                	add	s0,sp,32
    800037e8:	84aa                	mv	s1,a0
  acquire(&itable.lock);
    800037ea:	0001c517          	auipc	a0,0x1c
    800037ee:	88e50513          	add	a0,a0,-1906 # 8001f078 <itable>
  ...
  ip->ref--;
    ...
    80003804:	37fd                	addw	a5,a5,-1
    80003806:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80003808:	0001c517          	auipc	a0,0x1c
    8000380c:	87050513          	add	a0,a0,-1936 # 8001f078 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    acquiresleep(&ip->lock);
    8000382e:	01048913          	add	s2,s1,16
    ...
    80003840:	83c50513          	add	a0,a0,-1988 # 8001f078 <itable>
    ...
    80003876:	80650513          	add	a0,a0,-2042 # 8001f078 <itable>
...
{
    800038ac:	1141                	add	sp,sp,-16
    800038ae:	e422                	sd	s0,8(sp)
    800038b0:	0800                	add	s0,sp,16
  st->dev = ip->dev;
    ...
    800038d8:	0ed7e963          	bltu	a5,a3,800039ca <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003922:	020d1d93          	sll	s11,s10,0x20
    80003926:	020ddd93          	srl	s11,s11,0x20
    8000392a:	05890613          	add	a2,s2,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    8000395a:	00a4d59b          	srlw	a1,s1,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    8000397c:	3ff4f713          	and	a4,s1,1023
    ...
    800039d0:	10d7e863          	bltu	a5,a3,80003ae0 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003a1a:	020d1d93          	sll	s11,s10,0x20
    80003a1e:	020ddd93          	srl	s11,s11,0x20
    80003a22:	05848513          	add	a0,s1,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    80003a5c:	00a9559b          	srlw	a1,s2,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    80003a7e:	3ff97713          	and	a4,s2,1023
...
{
    80003aec:	1141                	add	sp,sp,-16
    80003aee:	e406                	sd	ra,8(sp)
    80003af0:	e022                	sd	s0,0(sp)
    80003af2:	0800                	add	s0,sp,16
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003b5e:	fc040613          	add	a2,s0,-64
    ...
    80003b7a:	fc240593          	add	a1,s0,-62
...
0000000080003d16 <dirlink>:
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003d44:	fc040613          	add	a2,s0,-64
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    80003d6e:	fc240513          	add	a0,s0,-62
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003dbc:	86050513          	add	a0,a0,-1952 # 80008618 <syscalls+0x1c8>
...
namei(char *path)
{
    80003dc8:	1101                	add	sp,sp,-32
    80003dca:	ec06                	sd	ra,24(sp)
    80003dcc:	e822                	sd	s0,16(sp)
    80003dce:	1000                	add	s0,sp,32
  char name[DIRSIZ];
  return namex(path, 0, name);
    80003dd0:	fe040613          	add	a2,s0,-32
...
{
    80003de6:	1141                	add	sp,sp,-16
    80003de8:	e406                	sd	ra,8(sp)
    80003dea:	e022                	sd	s0,0(sp)
    80003dec:	0800                	add	s0,sp,16
...
write_head(void)
{
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e36:	d1e70713          	add	a4,a4,-738 # 80020b50 <log+0x30>
    80003e3a:	87aa                	mv	a5,a0
    80003e3c:	060a                	sll	a2,a2,0x2
    80003e3e:	962a                	add	a2,a2,a0
    hb->block[i] = log.lh.block[i];
    80003e40:	4314                	lw	a3,0(a4)
    80003e42:	cff4                	sw	a3,92(a5)
  for (i = 0; i < log.lh.n; i++) {
    80003e44:	0711                	add	a4,a4,4
    80003e46:	0791                	add	a5,a5,4
    ...
    80003e74:	0af05d63          	blez	a5,80003f2e <install_trans+0xc2>
{
    ...
    80003e92:	cc2a8a93          	add	s5,s5,-830 # 80020b50 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003e96:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003e98:	0001d997          	auipc	s3,0x1d
    80003e9c:	c8898993          	add	s3,s3,-888 # 80020b20 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003eb6:	2a05                	addw	s4,s4,1
    80003eb8:	0a91                	add	s5,s5,4
    ...
    80003ef0:	05890593          	add	a1,s2,88
    80003ef4:	05850513          	add	a0,a0,88
    ...
    80003f2a:	6121                	add	sp,sp,64
    80003f2c:	8082                	ret
    80003f2e:	8082                	ret

0000000080003f30 <initlog>:
{
    80003f30:	7179                	add	sp,sp,-48
    ...
    80003f3c:	1800                	add	s0,sp,48
    80003f3e:	892a                	mv	s2,a0
    80003f40:	89ae                	mv	s3,a1
  initlock(&log.lock, "log");
    80003f42:	0001d497          	auipc	s1,0x1d
    80003f46:	bde48493          	add	s1,s1,-1058 # 80020b20 <log>
    80003f4a:	00004597          	auipc	a1,0x4
    80003f4e:	6de58593          	add	a1,a1,1758 # 80008628 <syscalls+0x1d8>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003f84:	bd070713          	add	a4,a4,-1072 # 80020b50 <log+0x30>
    80003f88:	060a                	sll	a2,a2,0x2
    80003f8a:	962a                	add	a2,a2,a0
    log.lh.block[i] = lh->block[i];
    80003f8c:	4ff4                	lw	a3,92(a5)
    80003f8e:	c314                	sw	a3,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003f90:	0791                	add	a5,a5,4
    80003f92:	0711                	add	a4,a4,4
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fae:	ba07a123          	sw	zero,-1118(a5) # 80020b4c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80004002:	2705                	addw	a4,a4,1
    80004004:	0027179b          	sllw	a5,a4,0x2
    80004008:	9fb9                	addw	a5,a5,a4
    8000400a:	0017979b          	sllw	a5,a5,0x1
    ...
    80004028:	afc50513          	add	a0,a0,-1284 # 80020b20 <log>
...
end_op(void)
{
    ...
    80004052:	0080                	add	s0,sp,64
  int do_commit = 0;

  acquire(&log.lock);
    80004054:	0001d497          	auipc	s1,0x1d
    80004058:	acc48493          	add	s1,s1,-1332 # 80020b20 <log>
  ...
  if(log.outstanding == 0){
    ...
    8000407c:	aa848493          	add	s1,s1,-1368 # 80020b20 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004098:	a8c48493          	add	s1,s1,-1396 # 80020b20 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004102:	a52a8a93          	add	s5,s5,-1454 # 80020b50 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004106:	0001da17          	auipc	s4,0x1d
    8000410a:	a1aa0a13          	add	s4,s4,-1510 # 80020b20 <log>
    8000410e:	018a2583          	lw	a1,24(s4)
    80004112:	012585bb          	addw	a1,a1,s2
    80004116:	2585                	addw	a1,a1,1
    ...
    8000413c:	05850593          	add	a1,a0,88
    80004140:	05848513          	add	a0,s1,88
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    8000416a:	2905                	addw	s2,s2,1
    8000416c:	0a91                	add	s5,s5,4
    ...
    8000418c:	9c07a223          	sw	zero,-1596(a5) # 80020b4c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041ac:	97890913          	add	s2,s2,-1672 # 80020b20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800041ea:	96a70713          	add	a4,a4,-1686 # 80020b50 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800041f8:	0711                	add	a4,a4,4
    800041fa:	fef61be3          	bne	a2,a5,800041f0 <log_write+0x56>
      break;
  }
  log.lh.block[i] = b->blockno;
    800041fe:	0621                	add	a2,a2,8
    80004200:	060a                	sll	a2,a2,0x2
    80004202:	0001d797          	auipc	a5,0x1d
    80004206:	91e78793          	add	a5,a5,-1762 # 80020b20 <log>
  ...
  release(&log.lock);
    ...
    80004266:	8be50513          	add	a0,a0,-1858 # 80020b20 <log>
...
holdingsleep(struct sleeplock *lk)
{
    ...
    8000435e:	1800                	add	s0,sp,48
    80004360:	84aa                	mv	s1,a0
  int r;
  
  acquire(&lk->lk);
    80004362:	00850913          	add	s2,a0,8
...
fileinit(void)
{
    800043a8:	1141                	add	sp,sp,-16
    800043aa:	e406                	sd	ra,8(sp)
    800043ac:	e022                	sd	s0,0(sp)
    800043ae:	0800                	add	s0,sp,16
  initlock(&ftable.lock, "ftable");
    800043b0:	00004597          	auipc	a1,0x4
    800043b4:	2d858593          	add	a1,a1,728 # 80008688 <syscalls+0x238>
    800043b8:	0001d517          	auipc	a0,0x1d
    800043bc:	8b050513          	add	a0,a0,-1872 # 80020c68 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    8000440a:	86250513          	add	a0,a0,-1950 # 80020c68 <ftable>
  ...
  return 0;
    ...
    80004422:	84a50513          	add	a0,a0,-1974 # 80020c68 <ftable>
...
filedup(struct file *f)
{
    ...
    80004442:	1000                	add	s0,sp,32
    80004444:	84aa                	mv	s1,a0
  acquire(&ftable.lock);
    80004446:	0001d517          	auipc	a0,0x1d
    8000444a:	82250513          	add	a0,a0,-2014 # 80020c68 <ftable>
  ...
  if(f->ref < 1)
    ...
    panic("filedup");
  f->ref++;
    8000445c:	2785                	addw	a5,a5,1
    8000445e:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80004460:	0001d517          	auipc	a0,0x1d
    80004464:	80850513          	add	a0,a0,-2040 # 80020c68 <ftable>
  ...
  return f;
    ...
    80004478:	6105                	add	sp,sp,32
    8000447a:	8082                	ret
    panic("filedup");
    8000447c:	00004517          	auipc	a0,0x4
    80004480:	21450513          	add	a0,a0,532 # 80008690 <syscalls+0x240>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044a4:	7c850513          	add	a0,a0,1992 # 80020c68 <ftable>
  ...
  release(&ftable.lock);
    ...
    800044de:	78e50513          	add	a0,a0,1934 # 80020c68 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    stati(f->ip, &st);
    80004584:	fb840593          	add	a1,s0,-72
    ...
    8000459e:	fb840613          	add	a2,s0,-72
    ...
    800045b0:	41f5551b          	sraw	a0,a0,0x1f
      return -1;
    return 0;
  }
  return -1;
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004648:	03079693          	sll	a3,a5,0x30
    8000464c:	92c1                	srl	a3,a3,0x30
    8000464e:	4725                	li	a4,9
    80004650:	02d76863          	bltu	a4,a3,80004680 <fileread+0xba>
    80004654:	0792                	sll	a5,a5,0x4
    80004656:	0001c717          	auipc	a4,0x1c
    8000465a:	57270713          	add	a4,a4,1394 # 80020bc8 <devsw>
    ...
    80004670:	03c50513          	add	a0,a0,60 # 800086a8 <syscalls+0x258>
    ...
    8000468c:	10078e63          	beqz	a5,800047a8 <filewrite+0x120>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800046ca:	c00b8b93          	add	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    800046ce:	6c05                	lui	s8,0x1
    800046d0:	c00c0c1b          	addw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    ...
    800046e6:	03079693          	sll	a3,a5,0x30
    800046ea:	92c1                	srl	a3,a3,0x30
    800046ec:	4725                	li	a4,9
    800046ee:	0ad76f63          	bltu	a4,a3,800047ac <filewrite+0x124>
    800046f2:	0792                	sll	a5,a5,0x4
    800046f4:	0001c717          	auipc	a4,0x1c
    800046f8:	4d470713          	add	a4,a4,1236 # 80020bc8 <devsw>
  ...
  return ret;
    ...
    80004794:	6161                	add	sp,sp,80
    80004796:	8082                	ret
    panic("filewrite");
    80004798:	00004517          	auipc	a0,0x4
    8000479c:	f2050513          	add	a0,a0,-224 # 800086b8 <syscalls+0x268>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004810:	ebc58593          	add	a1,a1,-324 # 800086c8 <syscalls+0x278>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    wakeup(&pi->nread);
    800048b2:	21848513          	add	a0,s1,536
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    800048e0:	6105                	add	sp,sp,32
    800048e2:	8082                	ret
    pi->readopen = 0;
    800048e4:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    800048e8:	21c48513          	add	a0,s1,540
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  int i = 0;
    ...
    8000493a:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    8000493c:	21848c13          	add	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004940:	21c48b93          	add	s7,s1,540
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004aa4:	2985                	addw	s3,s3,1
    80004aa6:	0905                	add	s2,s2,1
    80004aa8:	fd3a91e3          	bne	s5,s3,80004a6a <piperead+0x70>
    80004aac:	89d6                	mv	s3,s5
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    80004aae:	21c48513          	add	a0,s1,540
...
{
    80004ae8:	1141                	add	sp,sp,-16
    80004aea:	e422                	sd	s0,8(sp)
    80004aec:	0800                	add	s0,sp,16
    80004aee:	87aa                	mv	a5,a0
    int perm = 0;
    if(flags & 0x1)
    80004af0:	8905                	and	a0,a0,1
    80004af2:	050e                	sll	a0,a0,0x3
      perm = PTE_X;
    if(flags & 0x2)
    80004af4:	8b89                	and	a5,a5,2
    80004af6:	c399                	beqz	a5,80004afc <flags2perm+0x14>
      perm |= PTE_W;
    80004af8:	00456513          	or	a0,a0,4
    return perm;
}
    80004afc:	6422                	ld	s0,8(sp)
    80004afe:	0141                	add	sp,sp,16
    80004b00:	8082                	ret
...
{
    80004b02:	df010113          	add	sp,sp,-528
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    80004b5e:	e5040613          	add	a2,s0,-432
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    80004b7e:	57f78793          	add	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
 ...
 bad:
  ...
  return -1;
    ...
    80004bb8:	21010113          	add	sp,sp,528
    80004bbc:	8082                	ret
    end_op();
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80004bea:	fffc8793          	add	a5,s9,-1 # fff <_entry-0x7ffff001>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004bfa:	ada50513          	add	a0,a0,-1318 # 800086d0 <syscalls+0x280>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = walkaddr(pagetable, va + i);
    80004c28:	02091593          	sll	a1,s2,0x20
    80004c2c:	9181                	srl	a1,a1,0x20
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004c52:	2d85                	addw	s11,s11,1
    80004c54:	038d0d1b          	addw	s10,s10,56
    ...
    80004c68:	e1840613          	add	a2,s0,-488
  ...
  sz = PGROUNDUP(sz);
    ...
    80004d0c:	19fd                	add	s3,s3,-1 # fff <_entry-0x7ffff001>
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80004d86:	0015069b          	addw	a3,a0,1
  ...
  ustack[argc] = 0;
    80004dc0:	00349793          	sll	a5,s1,0x3
    80004dc4:	f9078793          	add	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdd230>
    80004dc8:	97a2                	add	a5,a5,s0
    80004dca:	f007b023          	sd	zero,-256(a5)
  sp -= (argc+1) * sizeof(uint64);
    80004dce:	00148693          	add	a3,s1,1
    80004dd2:	068e                	sll	a3,a3,0x3
    80004dd4:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    80004dd8:	ff097913          	and	s2,s2,-16
  sz = sz1;
    80004ddc:	e0843983          	ld	s3,-504(s0)
  if(sp < stackbase)
    80004de0:	f57968e3          	bltu	s2,s7,80004d30 <exec+0x22e>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80004de4:	e9040613          	add	a2,s0,-368
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004e2a:	158a8513          	add	a0,s5,344
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    80004eb8:	fdc40593          	add	a1,s0,-36
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004eda:	01a70793          	add	a5,a4,26
    80004ede:	078e                	sll	a5,a5,0x3
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004f1e:	0d050793          	add	a5,a0,208
  ...
  return -1;
    ...
    80004f3a:	6105                	add	sp,sp,32
    80004f3c:	8082                	ret
      p->ofile[fd] = f;
    80004f3e:	01a50793          	add	a5,a0,26
    80004f42:	078e                	sll	a5,a5,0x3
...
create(char *path, short type, short major, short minor)
{
  ...
  if((dp = nameiparent(path, name)) == 0)
    80004f64:	fb040593          	add	a1,s0,-80
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004f80:	fb040593          	add	a1,s0,-80
    ...
    80004fb0:	37f9                	addw	a5,a5,-2
    80004fb2:	17c2                	sll	a5,a5,0x30
    80004fb4:	93c1                	srl	a5,a5,0x30
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80005018:	fb040593          	add	a1,s0,-80
  ...
  return ip;
    ...
    8000504e:	6a658593          	add	a1,a1,1702 # 800086f0 <syscalls+0x2a0>
    ...
    80005066:	69658593          	add	a1,a1,1686 # 800086f8 <syscalls+0x2a8>
...
0000000080005176 <sys_write>:
{
  ...
  return filewrite(f, p, n);
    ...
    800051ca:	6145                	add	sp,sp,48
    800051cc:	8082                	ret

00000000800051ce <sys_close>:
{
    800051ce:	1101                	add	sp,sp,-32
    800051d0:	ec06                	sd	ra,24(sp)
    800051d2:	e822                	sd	s0,16(sp)
    800051d4:	1000                	add	s0,sp,32
  if(argfd(0, &fd, &f) < 0)
    800051d6:	fe040613          	add	a2,s0,-32
    800051da:	fec40593          	add	a1,s0,-20
  ...
  myproc()->ofile[fd] = 0;
    ...
    800051fa:	07e9                	add	a5,a5,26
    800051fc:	078e                	sll	a5,a5,0x3
...
0000000080005262 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    8000528a:	f5040593          	add	a1,s0,-176
  ...
  if((ip = namei(old)) == 0){
    800052a6:	ed040513          	add	a0,s0,-304
  ...
  if((dp = nameiparent(new, name)) == 0)
    800052e6:	fd040593          	add	a1,s0,-48
    800052ea:	f5040513          	add	a0,s0,-176
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    8000530e:	fd040593          	add	a1,s0,-48
  ...
  return -1;
    ...
    800053a8:	6155                	add	sp,sp,304
    800053aa:	8082                	ret

00000000800053ac <sys_unlink>:
{
    800053ac:	7151                	add	sp,sp,-240
    ...
    800053b8:	1980                	add	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    800053ba:	08000613          	li	a2,128
    800053be:	f3040593          	add	a1,s0,-208
  ...
  if((dp = nameiparent(path, name)) == 0){
    800053d8:	fb040593          	add	a1,s0,-80
    800053dc:	f3040513          	add	a0,s0,-208
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    800053f8:	2fc58593          	add	a1,a1,764 # 800086f0 <syscalls+0x2a0>
    800053fc:	fb040513          	add	a0,s0,-80
    ...
    80005410:	2ec58593          	add	a1,a1,748 # 800086f8 <syscalls+0x2a8>
    80005414:	fb040513          	add	a0,s0,-80
  ...
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005424:	f2c40613          	add	a2,s0,-212
    80005428:	fb040593          	add	a1,s0,-80
  ...
  memset(&de, 0, sizeof(de));
    ...
    8000545a:	fc040513          	add	a0,s0,-64
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    8000546c:	fc040613          	add	a2,s0,-64
  ...
  return 0;
    ...
    800054d0:	23450513          	add	a0,a0,564 # 80008700 <syscalls+0x2b0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800054f0:	f1840613          	add	a2,s0,-232
...
sys_open(void)
{
  ...
  argint(1, &omode);
    8000558c:	f4c40593          	add	a1,s0,-180
  ...
  if((n = argstr(0, path, MAXPATH)) < 0)
    ...
    8000559e:	f5040593          	add	a1,s0,-176
  ...
  f->readable = !(omode & O_WRONLY);
    ...
    80005626:	0017c713          	xor	a4,a5,1
    8000562a:	8b05                	and	a4,a4,1
    8000562c:	00e90423          	sb	a4,8(s2)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80005630:	0037f713          	and	a4,a5,3
    80005634:	00e03733          	snez	a4,a4
    80005638:	00e904a3          	sb	a4,9(s2)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    8000563c:	4007f793          	and	a5,a5,1024
  ...
  return fd;
    ...
    if((ip = namei(path)) == 0){
    8000567a:	f5040513          	add	a0,s0,-176
...
sys_mkdir(void)
{
    80005714:	7175                	add	sp,sp,-144
    80005716:	e506                	sd	ra,136(sp)
    80005718:	e122                	sd	s0,128(sp)
    8000571a:	0900                	add	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005728:	f7040593          	add	a1,s0,-144
    ...
    80005740:	f7040513          	add	a0,s0,-144
...
sys_mknod(void)
{
    80005774:	7135                	add	sp,sp,-160
    80005776:	ed06                	sd	ra,152(sp)
    80005778:	e922                	sd	s0,144(sp)
    8000577a:	1100                	add	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800057a4:	f7040593          	add	a1,s0,-144
    ...
    800057c0:	f7040513          	add	a0,s0,-144
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005816:	f6040593          	add	a1,s0,-160
    ...
    80005828:	f6040513          	add	a0,s0,-160
...
sys_exec(void)
{
    ...
    800058aa:	0380                	add	s0,sp,448
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    800058ac:	e4840593          	add	a1,s0,-440
  ...
  memset(argv, 0, sizeof(argv));
    ...
    800058f2:	00391513          	sll	a0,s2,0x3
    800058f6:	e4040593          	add	a1,s0,-448
    ...
    if(i >= NELEM(argv)){
    80005934:	0905                	add	s2,s2,1
    80005936:	09a1                	add	s3,s3,8
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000593c:	f5040913          	add	s2,s0,-176
...
sys_pipe(void)
{
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005a0a:	fc440613          	add	a2,s0,-60
    ...
    80005a22:	fc040613          	add	a2,s0,-64
    80005a26:	fd843583          	ld	a1,-40(s0)
    80005a2a:	0591                	add	a1,a1,4
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005a40:	07e9                	add	a5,a5,26
    80005a42:	078e                	sll	a5,a5,0x3
    ...
    80005a78:	0007c763          	bltz	a5,80005a86 <sys_pipe+0xe2>
      p->ofile[fd0] = 0;
    80005a7c:	07e9                	add	a5,a5,26
    80005a7e:	078e                	sll	a5,a5,0x3
...
0000000080005ab0 <kernelvec>:
    ...
    80005af0:	dfffc0ef          	jal	800028ee <kerneltrap>
